...
const faqs = [
  {
    question: "Is StylistVerify a blacklist platform?",
    answer:
      "No. StylistVerify is not designed to blacklist stylists. It provides verified employment records so salon owners can make informed hiring decisions based on factual history.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. If a stylist has worked at multiple salons that use StylistVerify, all employment records will appear in chronological order on the verification page.",
  },
  {
      ...
      <div className="mx-auto max-w-3xl">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Everything you need to know about StylistVerify
          </p>
        </div>
